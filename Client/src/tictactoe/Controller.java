...
public class Controller {
    ...
    private Image imgX = new Image("/tictactoe/X.png");
    private Image imgO = new Image("/tictactoe/O.png");
    ...
    private int checkForEndGame(int status) {
        ...
        if (cellList.get(0).getStatus() == status && cellList.get(4).getStatus() == status && cellList.get(8).getStatus() == status) {  
            return status;
        }
        if (cellList.get(2).getStatus() == status && cellList.get(4).getStatus() == status && cellList.get(6).getStatus() == status) {   
            return status;
        }
